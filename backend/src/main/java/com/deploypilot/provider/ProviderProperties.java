...
public class ProviderProperties {
    ...
    public ProviderProperties(
        ...
        @Value("${deploypilot.providers.supabase-api-base-url:https://api.supabase.com/v1}") String supabaseBaseUrl) {
        ...
        this.supabaseBaseUrl = trimTrailingSlash(supabaseBaseUrl);
    }
    ...
    public String supabaseBaseUrl() { return supabaseBaseUrl; }
